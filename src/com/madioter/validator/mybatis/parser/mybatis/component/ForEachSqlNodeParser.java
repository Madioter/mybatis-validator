 ...
 */
public class ForEachSqlNodeParser implements IComponentNodeParser {

    @Override
    public boolean matches(Object object) {
        if (object.getClass().getName().endsWith(MyBatisTagConstant.FOR_EACH_SQL_NODE)) {
            return true;
        } else {
            return false;
        }
    ...
    public ISqlComponent getComponent(Object object) {
        return new ForEachSqlComponent(object);
    }
}
